...
echo "build.sh complete, moving Acquia docroot to $TEMP_BUILD/acquia_docroot"
mv $TEMP_BUILD/$HOSTTYPE/docroot $TEMP_BUILD/acquia_docroot

echo "Copying build root to $TEMP_BUILD/$HOSTTYPE and update to docroot"
cp -R $TEMP_BUILD/drushmake $TEMP_BUILD/$HOSTTYPE
mv $TEMP_BUILD/$HOSTTYPE/drushmake $TEMP_BUILD/$HOSTTYPE/docroot
...
# Switch back to Acquia repo to get changes
cd $TEMP_BUILD/$HOSTTYPE

# Checkout files that we don't want removed
